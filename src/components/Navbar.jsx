...
const Navbar = () => {
    ...
    return (
        ...
        >
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            >        {
                                    addToCardOpen && <AddToCard setAddToCardOpen={setAddToCardOpen} />
                                }
            ...
            <div
                className={`md:hidden overflow-hidden transition-all duration-400 ease-in-out border-b border-white/6 bg-[#0b0b0b]/95 backdrop-blur-xl ${menuOpen ? "max-h-125 opacity-100" : "max-h-0 opacity-0"
                    }`}
            >
